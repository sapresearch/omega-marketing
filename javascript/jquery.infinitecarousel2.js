	...
	$.fn.extend({ 
		...
		var options = $.extend(defaults, options);
			...
			for(i=1;i<=o.inView;i++)
			{
				...
				$('#textholder'+randID+'_'+i).height('30px').css({'backgroundColor':'#191919','opacity':'0.7'});
			...
			if(o.showControls)
			{
				...
				html = '<div id="btn_rt'+randID+'" style="position:absolute;right:2px;top:'+arrowsTop+'px;cursor:pointer;border:none;width:18px;height:18px;background:url('+o.imagePath+'leftright.gif) no-repeat 0 -18px"></div>';
				html += '<div id="btn_lt'+randID+'" style="position:absolute;left:2px;top:'+arrowsTop+'px;cursor:pointer;border:none;width:18px;height:18px;background:url('+o.imagePath+'leftright.gif) no-repeat 0 0"></div>';
